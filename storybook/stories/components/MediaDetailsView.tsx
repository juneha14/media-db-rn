...
import { Cast, MovieDetails, TMovie } from "../../../src/models";
import { MediaDetailsView } from "../../../src/screens/MediaDetails/MediaDetailsView";
import { Colors } from "../../../src/components/theme";

export const MediaDetailsViewInternal: React.FC = () => {
  const infoDetails: MovieDetails = {
    adult: false,
    backdropPath: "/jMWkd0fuwbG39eJpzycJzPWMCww.jpg",
